...
MeScroll.prototype.extendDownScroll = function(optDown) {
	...
	MeScroll.extend(optDown, {
		...
		minAngle: 45, //触发下拉最少要偏移的角度(滑动的轨迹与水平线的锐角值),取值区间  [0,90];默认45度,即向下滑动的角度大于45度(方位角为45°~145°及225°~315°)则触发下拉;而小于45度,将不触发下拉,避免与左右滑动的轮播等组件冲突;<br/>注意:没有必要配置超出[0,90]区间的值,否则角度限制无效; 因为假设配置30, 生效的方位角就是30°到160° 和 210°到330°的范围;<br/>这是1.1.6版本新增的配置,请检查最新版~
